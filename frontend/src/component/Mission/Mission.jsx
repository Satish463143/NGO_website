         ...
         <div className="mission">
            ...
            <div className="mission_grid">
                <div className="mission_box">
                    ...
                    <p>
                        Seeks to instill environmental awareness and encourage eco-friendly behaviors through community engagement and education, ensuring communities are part of the solution to climate change.
                    </p>
                </div>
                <div className="mission_box">
                    <span>
                ...
                <div className="mission_box">
                    ...
                    <p>
                    Provide rural women with the skills, knowledge, and opportunities to participate in economic activities, fostering financial independence and self-sufficiency.
                ...
                <div className="mission_box">
                   ...
                   <svg viewBox="0 0 640 512" fill="#32d8fc" width="36"  height="36" xmlns="http://www.w3.org/2000/svg"><path d="M624 384h-608C7.25 384 0 391.3 0 400V416c0 35.25 28.75 64 64 64h512c35.25 0 64-28.75 64-64v-16C640 391.3 632.8 384 624 384zM128 96h384v256h64V80C576 53.63 554.4 32 528 32h-416C85.63 32 64 53.63 64 80V352h64V96zM304 336h32c8.801 0 16-7.201 16-16V272h48C408.8 272 416 264.8 416 256V224c0-8.801-7.199-16-16-16H352V160c0-8.801-7.199-16-16-16h-32C295.2 144 288 151.2 288 160v48H240C231.2 208 224 215.2 224 224v32c0 8.799 7.199 16 16 16H288V320C288 328.8 295.2 336 304 336z"/></svg>
                    ...
                    <p>
                    Recognize the importance of mental health as part of personal and community resilience. This aspect integrates mental health awareness and services into development efforts, aiming to reduce stress, anxiety, and other mental health challenges, particularly in marginalized communities
                    </p>
                </div>
                <div className="mission_box">
                    <span>
                    ...
                    <p>
                    Focuses on fostering women’s economic independence through education and skills development, ensuring that women in rural and marginalized areas have the means to support themselves and their families.
                    </p>
                </div>
                <div className="mission_box">
                    <span>
                    ...
                    <p>Economic empowerment, particularly for rural women, focuses on developing sustainable, long-term income streams through skill-building, entrepreneurship, and employment opportunities.
